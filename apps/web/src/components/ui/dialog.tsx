...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-xl p-1 text-text-secondary transition-all duration-150 ease-in-out hover:bg-surface hover:text-text-primary focus:outline-none focus:ring-2 focus:ring-ring/30">
        <X className="h-4 w-4" />
...
function DialogTitle({
  ...
  return (
    <h2 className={cn("text-h3 text-text-primary", className)} {...props} />
  );
}
