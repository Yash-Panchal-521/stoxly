...
builder.Services.AddScoped<ISimulationPortfolioService, SimulationPortfolioService>();
builder.Services.AddScoped<ISimulationTradeService, SimulationTradeService>();
