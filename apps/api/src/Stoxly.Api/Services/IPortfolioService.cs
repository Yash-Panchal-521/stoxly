...
public interface IPortfolioService
{
    ...
    Task<PortfolioResponse> CreateSimulationPortfolioAsync(string userId, CreateSimulationPortfolioRequest request);
    ...
    Task<SimulationPortfolioResponse?> GetSimulationPortfolioAsync(string userId);
}
